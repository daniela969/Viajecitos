const dataDestinos = [  {
  ...
  {
    nombre: "Liberación de tortugas en Bahía Solano",
    descripcion:
      "La liberación de tortugas marinas en Bahía Solano, en la costa del Pacífico colombiano, es una experiencia turística y ambiental que permite a los visitantes conocer y participar en la conservación de estas especies. Cada año, durante las temporadas de anidación, comunidades locales y organizaciones ambientales protegen los huevos de tortuga y acompañan el nacimiento de las crías para ayudarlas a llegar al océano de forma segura. Este destino combina el contacto con la naturaleza, la educación ambiental y la belleza de los paisajes del Pacífico colombiano. Además de la liberación de tortugas, Bahía Solano ofrece playas, selvas, biodiversidad y una conexión cercana con la cultura de sus comunidades, convirtiéndolo en un lugar ideal para quienes buscan turismo ecológico y experiencias únicas.",
    imagen:
