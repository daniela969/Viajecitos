const dataPaquete = [
  {
    ...
    incluye: [
      ...
      "Guía acompañante durante la ruta",
      "Visita a pueblos históricos, iglesias y monumentos",
      "Entrada a la Catedral de Santiago de Compostela",
      "Experiencia gastronómica con platos tradicionales de Galicia.",
    ],
...

  {
    ...
    incluye: [
      ...
      "Transporte turístico y recorridos por la ciudad",
      "Entrada a eventos y actividades del Carnaval de Venecia",
      "Visita a la Plaza San Marcos, canales y lugares históricos",
      "Experiencia con máscaras venecianas tradicionales",
      "Tour gastronómico con comida típica italiana.",
    ],
...

  {
    ...
    incluye: [
      ...
      "City Tour por La Candelaria, Plaza de Bolívar y Museo del Oro",
      "Ascenso a Monserrate",
      "Tour nocturno por la Zona T y Parque de la 93",
      "Entrada VIP a una de las mejores discotecas de la ciudad",
      "Seguro de viaje",
    ],
  ...
  },
  {
    ...
    incluye: [
      ...
      "Entrada al Museo del Oro y Museo Botero",
      "Ascenso a Monserrate",
      "Excursión de un día a la Catedral de Sal de Zipaquirá",
      "Visita al Jardín Botánico y al Parque Simón Bolívar",
    ...
    precio: "1095",
    imagen:
      "https://ambienteurbano.co/wp-content/uploads/2018/02/Simon-Bolivar-2.jpg",
    destinoId: "aa414ee8-d8f8-4533-9607-869df8d06e0d",
  },
  {
    ...
    incluye: [
      ...
      "Desayunos diarios",
      "Traslados aeropuerto – hotel – aeropuerto",
      "Ascenso y visita al Santuario de Monserrate.",
      "Recorrido por las principales iglesias históricas de La Candelaria.",
      "Excursión de un día a la Catedral de Sal de Zipaquirá",
      "Visita al Santuario del Divino Niño del 20 de Julio",
      "Tiempo libre para actividades de reflexión o compras de artículos religiosos",
      "Seguro de viajes",
    ],
    duracion: "5 días / 4 noches",
    precio: "749",
